        ...
        >
          <div className={style.air__menuLeft__outer}>
            ...
            <a href="#" onClick={e => e.preventDefault()} className={style.air__menuLeft__logo}>
              ...
              <div className={style.air__menuLeft__logo__name}>Links Watch</div>
              <div className={style.air__menuLeft__logo__descr}>Keep your browser Clean</div>
            </a>
            <a href="#" onClick={e => e.preventDefault()} className={style.air__menuLeft__user}>
              ...
              <div className={style.air__menuLeft__user__name}>Satwick D</div>
